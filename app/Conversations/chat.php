        ...
        $botman->hears('.*', function (BotMan $bot) {
            ...
            if ($extras['apiReply'] == "info.pagina") {
                ...
                if (Auth::check()) {
                    ...
                    $bot->reply("¡Hola, {$user}! sera un gusto");
                    $bot->startConversation(new prueba);
                } else {
                    $bot->reply('Hola, visitante. Por favor, inicia sesión, para acceder al generador de plantillas y más. <a href="' . route('login') . '" target="_blank">Inicia sesion</a>');
                }
